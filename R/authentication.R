...
download_datasets <- function( dhs_ , ... ){
...
##' @examples
##'
##' dhs_authenticate(your_email="rdhs.tester@gmail.com",your_password="rdhstesting",your_project="Testing Malaria Investigations")
##'
##'
##'
...
dhs_authenticate <- function( your_email , your_password , your_project ){
  ...
  project.line <- unique( y[ grepl( "option value" , y ) & grepl( paste0(strsplit(your_project,"")[[1]][1:30],collapse="") , y , fixed = TRUE ) ] )
