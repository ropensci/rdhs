...
```{r extract_questions, message=FALSE, echo=FALSE}
...
```{r extract_variables, message=FALSE, echo=FALSE}
...
```{r reformat, message=FALSE, echo=FALSE}
...
```{r regression analysis, message=FALSE, echo=FALSE}
...
comparison <- cbind(results[,c(1,2,6)],api[])
