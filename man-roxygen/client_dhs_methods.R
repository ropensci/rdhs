...
##'
##'   \emph{Usage:}
##'   \code{get_var_labels(dataset_filenames = NULL, dataset = NULL)}
##'
##'   \emph{Arguments:}
##'   \itemize{
...
##'     }
##'
##'     \item{\code{dataset}:   A full read in dataset that has not been reformatted whe declaring \code{client$get_datasets()}
##'     }
##'   }
##'
##'   \emph{Value}:
