...
[![Project Status: WIP - Initial development is in progress, but there has not yet been a stable, usable release suitable for the public.](http://www.repostatus.org/badges/latest/wip.svg)](http://www.repostatus.org/#wip) [![Travis-CI Build Status](https://travis-ci.org/OJWatson/rdhs.png?branch=master)](https://travis-ci.org/OJWatson/rdhs) [![codecov.io](https://codecov.io/github/OJWatson/rdhs/coverage.svg?branch=master)](https://codecov.io/github/OJWatson/rdhs?branch=master) [![Documentation via pkgdown](tools/pkgdownshield.svg)](https://ojwatson.github.io/rdhs/)

![]()<img src="tools/logo.png" width="50%">
...
#> Downloading: 
#> Congo Democratic Republic 2013 DHS Geographic Data Flat ASCII data (.dat)
#> 
  |                                                                       
  |                                                                 |   0%
  |                                                                       
...
#> Source: "C:\Users\Oliver\AppData\Local\Temp\RtmpuSo4uj\file2d945f1e5122", layer: "CDGE61FL"
#> with 536 features
#> It has 20 fields
#> Dataset download finished
#> Logging into DHS website...
#> Downloading: 
#> Tanzania 2015 DHS Geographic Data Flat ASCII data (.dat)
#> 
  |                                                                       
  |                                                                 |   0%
  |                                                                       
  ...
  |=================================================================| 100%
#> OGR data source with driver: ESRI Shapefile 
#> Source: "C:\Users\Oliver\AppData\Local\Temp\RtmpuSo4uj\file2d9443ef3010", layer: "TZGE7AFL"
#> with 608 features
#> It has 20 fields
#> Dataset download finished
...
#> Logging into DHS website...
#> Downloading: 
#> Congo Democratic Republic 2013 DHS Household Member Recode Flat ASCII data (.dat)
#> 
  |                                                                       
  |                                                                 |   0%
  |                                                                       
...
#> Logging into DHS website...
#> Downloading: 
#> Tanzania 2015 DHS Household Member Recode Flat ASCII data (.dat)
#> 
  |                                                                       
  |                                                                 |   0%
  |                                                                       
