...
#>  $ FileSize            : int  6595349 6622102 2171918
...
#>  $ FileDateLastModified: chr  "September, 19 2016 09:58:23" "August, 07 2018 17:36:25" "June, 11 2019 15:38:22"
...
#>  $ FileName            : chr  "CDPR61FL.ZIP" "TZPR7AFL.ZIP" "TZPR7IFL.ZIP"
...
#>  dhs_datasets(surveyYearStart = 1986) 2.126983 2.126983 2.126983 2.126983
#>        uq      max neval
#>  2.126983 2.126983     1
...
#> Unit: milliseconds
#>                                  expr      min       lq     mean   median
#>  dhs_datasets(surveyYearStart = 1986) 1.148042 1.148042 1.148042 1.148042
#>        uq      max neval
#>  1.148042 1.148042     1
```
...
questions <- search_variables(datasets$FileName, variables = c("hv024", "hml35"),
                                     reformat=TRUE)
#> Downloading: 
#> Tanzania 2017 MIS Household Member Recode Flat ASCII data (.dat) [TZPR7IFL.ZIP]
