...
Each call to a DHS endpoint returns a `data.frame` by default with all the results available by default. If you wish to return a `data.table` then you can change the default behaviour by setting the following system environment variable using `Sys.setenv("rdhs_DATA_TABLE" = TRUE)`. 
...
## 1 3199096 Malaria prevalence according to RDT CD2013DHS           1  17.1
...
##     get_root: function () 
##     get_variable_labels: function (dataset_filenames = NULL, dataset_paths = NULL) 
...
##     cache_date: 2018-05-08 14:14:53
...
##  dhs_surveys(client = client) 620.4408 620.4408 620.4408 620.4408 620.4408
##       max neval
##  620.4408     1
```
...
##  dhs_surveys() 421.0524 421.0524 421.0524 421.0524 421.0524 421.0524     1
```
...
## Source: "C:\Users\Oliver\AppData\Local\Temp\Rtmp2xuMOI\file22686b90979", layer: "CDGE61FL"
## with 536 features
## It has 20 fields
## OGR data source with driver: ESRI Shapefile 
## Source: "C:\Users\Oliver\AppData\Local\Temp\Rtmp2xuMOI\file22683ff6e6e", layer: "TZGE7AFL"
## with 608 features
## It has 20 fields
```

The function returns a list with a file path to where the downloaded datasets have been saved to.  By default the files will download quietly, i.e. no progress is shown. However, if you want to see the progress then set `Sys.setenv("rdhs_LOUD_DOWNLOAD" = TRUE)`.
...
##                           Survey_RDT_Denom API_RDT_Denom
## Bandundu.CDPR61FL                1415.6056          1414
## Bas-Congo.CDPR61FL                342.6473           347
## Equateur.CDPR61FL                1267.4746          1236
## Kasai-Occidental.CDPR61FL         604.6050           612
## Kasai-Oriental.CDPR61FL           892.6006           894
## Katanga.CDPR61FL                  861.2030           844
##                                     API_Regions  SurveyID
## Bandundu.CDPR61FL                      Bandundu CD2013DHS
## Bas-Congo.CDPR61FL                    Bas-Congo CD2013DHS
## Equateur.CDPR61FL                      Equateur CD2013DHS
## Kasai-Occidental.CDPR61FL Kasa<U+00EF> Occident CD2013DHS
## Kasai-Oriental.CDPR61FL   Kasa<U+00EF> Oriental CD2013DHS
## Katanga.CDPR61FL                        Katanga CD2013DHS
```
