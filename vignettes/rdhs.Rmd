...
is really excellent for leaving no extracted data later on open to missinterpretation, i.e. 


```{r Download surveys, include=TRUE, message = FALSE, warning = FALSE, collapse = TRUE, comment = "#>",cache=TRUE}
...
# extract the questions, an fitler by search terms.
questions <- client$survey_questions(stata_surveys[c(1,25,50,75,100),],search_terms = c("fever","malaria","test"))

```

This resultant data frame can then be used to check which codes you may want to include 
