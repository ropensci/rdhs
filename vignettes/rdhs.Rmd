...
```{r Client creation, include=TRUE, message = FALSE, warning = FALSE, purl = NOT_CRAN, eval = NOT_CRAN, cache=TRUE}
...
```{r API fail, include=TRUE, message = FALSE, error=FALSE, purl= FALSE, warning = FALSE}
