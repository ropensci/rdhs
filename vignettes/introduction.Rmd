...
<img src="C:/Users/Oliver/GoogleDrive/AcademicWork/Imperial/git/rdhs/vignettes/introduction_files/figure-html/unnamed-chunk-1-1.png" style="display: block; margin: auto;" />
...
```
## C:\Users\Oliver\AppData\Local\Oliver\rdhs\Cache/rdhs.json has been added to your .gitignore
```
...
##  dhs_surveys(surveyYear = 1991) 110.775 110.775 110.775 110.775 110.775
##      max neval
##  110.775     1
```
...
##  dhs_surveys(surveyYear = 1991) 2.340517 2.340517 2.340517 2.340517
##        uq      max neval
##  2.340517 2.340517     1
```
